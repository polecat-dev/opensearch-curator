...
class TestActionFileAllocation(CuratorTestCase):
    def test_include(self):
        ...
        self.write_config(
            ...
            testvars.allocation_test.format(KEY, VALUE, alloc, False),
        )
    ...
    def test_remove_exclude_with_none_value(self):
        ...
        self.write_config(
            self.args['actionfile'],
            testvars.allocation_test.format(KEY, empty, alloc, False),
        )
        idx1, idx2 = ('my_index', 'not_my_index')
        self.create_index(idx1)
        self.create_index(idx2)
    ...
    def test_wait_for_completion(self):
        ...
        self.write_config(
            self.args['actionfile'],
            testvars.allocation_test.format(KEY, VALUE, alloc, True),
        )
        idx1, idx2 = ('my_index', 'not_my_index')
        self.create_index(idx1)
        self.create_index(idx2)
