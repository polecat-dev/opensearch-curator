...
import tempfile
import click
from opensearch_client.debug import debug
from opensearch_client.defaults import LOGGING_SETTINGS
from opensearch_client import config as cfgfn
...
DEFAULTCFG = "\n".join(
    ["---", "opensearch:", "  client:", f"    hosts: [{DEFAULT_HOST}]"]
)
