"""
opensearch_client Module Initialization

This module initializes the opensearch_client package, providing utilities for building
OpenSearch client connections and debugging tools.

Exported Objects:
    - Builder: A class to construct OpenSearch client connections.
...
Example Usage:
    ...
    ['http://localhost:9200']
    >>> from opensearch_client import debug
