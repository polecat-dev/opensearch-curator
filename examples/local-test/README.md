...
1. **OpenSearch running on localhost:19200**
   ```powershell
   # Start OpenSearch with Docker
   docker run -d -p 19200:9200 -p 9600:9600 \
...
**Risk Level:** 🟢 Safe (disable_action: True)
...
**Filters:** 
  - Pattern: test-*
  - Age: >7 days
**Risk Level:** 🔴 **DELETES DATA** when disable_action: False
...
**Filters:**
  - Pattern: logs-*
  - Age: >1 day
**Risk Level:** 🟡 Requires repository setup
**Prerequisites:**
...
**Filters:**
  - Pattern: logs-*
  - Age: >30 days
**Risk Level:** 🟡 Indices become read-only but recoverable
...
**Risk Level:** 🟡 Resource intensive, takes time
...
**Filters:**
  - Pattern: logs-*
  - Age: >60 days
**Risk Level:** 🟡 Reduces data redundancy
...
**Filters:**
  - Pattern: test-*
  - Age: >3 days
**Risk Level:** 🟢 Safe - keeps original indices
**Prerequisites:**
...
**Filters:**
  - Pattern: test-*
  - Age: >7 days
**Risk Level:** 🔴 **DELETES ORIGINALS** after conversion
...
**Filters:**
  - Pattern: logs-*
  - Age: >1 day
**Risk Level:** 🟡 Requires existing snapshot
...
**Risk Level:** 🟡 Requires understanding of alias behavior
...
1. ✅ Read this README
2. ✅ Start OpenSearch on port 19200
3. ✅ Run create-test-data.ps1 to create sample indices
4. ✅ Test 01-list-all-indices.yml with --dry-run
5. ✅ Modify an action file for your use case
6. ✅ Run with --dry-run, verify output
7. ✅ Set disable_action: False and execute
